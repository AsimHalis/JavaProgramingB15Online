...
//        String sentence = "I Love Java";
        ...
        System.out.println("sentence = " + sentence);//sentence = You Understand Java

        String secondWord;
        int firstSpaceIndex = sentence.indexOf(" ");
        System.out.println("firstSpaceIndex = " + firstSpaceIndex);//firstSpaceIndex = 3

        int lastSpaceIndex = sentence.lastIndexOf(" ");
        System.out.println("lastSpaceIndex = " + lastSpaceIndex);//lastSpaceIndex = 14

        //System.out.println(sentence.substring(1 + 1, 6));
        secondWord = sentence.substring(firstSpaceIndex + 1, lastSpaceIndex);
        System.out.println("secondWord = " + secondWord);//secondWord = Understand
        ...
        System.out.println("firstWord = " + firstWord);//firstWord = You
        ...
        System.out.println("lastWord = " + lastWord);//lastWord =  Java

        String lastWord3 = sentence.substring(16);
        System.out.println("lastWord3 = " + lastWord3);//ava
    }
}
